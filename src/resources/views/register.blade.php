      ...
      <div class="card-body">
        ...
        <form method="POST" action="register" class="fw-semibold">
          ...
          <input type="text" name="phoneNumber" class="form-control @error('phoneNumber') is-invalid @enderror"
            placeholder="08xxxxxxxxxx" value={{ old('phoneNumber') }}>
          @error('phoneNumber')
          <div class="invalid-feedback">
            {{ $message }}
          </div>
          ...
          <input name="birthDate" type="date" class="form-control @error('birthDate') is-invalid @enderror"
            placeholder="password" required value={{ old('birthDate') }}>
          @error('birthDate')
          <div class="invalid-feedback">
            {{ $message }}
          </div>
