      ...
      <div class="card start-50 translate-middle-x my-3" style="width: 980px">
        ...
        <div class="card-body">
          <div class="container g-3">
            ...
            <div class="row">
              <div class="col">
                <input name="nama-event" type="text" class="form-control form-control-lg rounded-0 @error('nama-event') @enderror"
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-sm text-end">
          <button type="submit" class="btn btn-sm fw-bold" style="background:#FF7A00;color:white;width:100px">GAS</button>
        </div>
      </div>
    </div>
  </footer>
