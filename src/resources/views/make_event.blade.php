...
@section('contents')
<div class="container">
  <h1 class="fw-bold text-center my-3">Buat <span style="color: #FF7A00">Event</span></h1>
  <div class="card start-50 translate-middle-x" style="width: 980px">
    ...
    <div class="card-body">
      <form action="" class="container g-3 needs-validation">
        <div class="row">
          <div class="col">
            <input type="text" class="form-control form-control-lg" name="" style="border:0; border-bottom:1px solid" id="" placeholder="Nama Event" required>
          </div>
        </div>
        <div class="row pt-4">
          <div class="col">
